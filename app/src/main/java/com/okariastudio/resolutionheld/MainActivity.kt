...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageVList : Array<ImageView> = arrayOf(
            findViewById(R.id.rond1),
            findViewById(R.id.rond2),
            findViewById(
                R.id.rond3
            ),
            findViewById(R.id.rond4),
            findViewById(R.id.rond5),
            findViewById(R.id.rond6),
            findViewById(R.id.rond7),
            findViewById(
                R.id.rond8
            ),
            findViewById(R.id.rond9),
            findViewById(R.id.rond10),
            findViewById(R.id.rond11),
            findViewById(
                R.id.rond12
            ),
            findViewById(R.id.rond13),
            findViewById(R.id.rond14),
            findViewById(R.id.rond15),
            findViewById(
                R.id.rond16
            ),
            findViewById(R.id.rond17),
            findViewById(R.id.rond18),
            findViewById(R.id.rond19),
            findViewById(
                R.id.rond20
            ),
            findViewById(R.id.rond21),
            findViewById(R.id.rond22),
            findViewById(R.id.rond23),
            findViewById(
                R.id.rond24
            ),
            findViewById(R.id.rond25),
            findViewById(R.id.rond26),
            findViewById(R.id.rond27),
            findViewById(
                R.id.rond28
            ),
            findViewById(R.id.rond29),
            findViewById(R.id.rond30),
            findViewById(R.id.rond31)
        )
        val imageDoneList = intArrayOf(
            R.drawable.blancun,
            R.drawable.blancdeux,
            R.drawable.blanc3,
            R.drawable.blanc4,
            R.drawable.blanc5,
            R.drawable.blanc6,
        ...
        bottomNav.selectedItemId = R.id.act1
